---
name: Test work
about: Add or improve behavior-focused verification
title: "test: "
labels: "type:test"
---
...
<!-- Before implementation: verify labels, milestone, Project fields, owner reviewer (default: `@geoffrey-xiao`), dependencies, and Definition of Ready. See docs/04-execution/deprail-v0.2-execution-package/tracking/WORKFLOW-GUIDE.md. -->
...
- [ ] Determinism or ordering
- [ ] Security or adversarial input
- [ ] Cross-platform behavior where relevant
