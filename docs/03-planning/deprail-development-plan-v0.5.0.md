...
v0.4.0-preview.2 was published with an owner-approved `go with approved gaps`, but issue #356 remains open. Its independent architecture/security review, rollback ownership/recovery procedure, Python/Java remediation coverage, cross-platform representative smoke, and signature/provenance dispositions remain open. The owner has explicitly directed that all five follow-ups remain tracked in #356 rather than be carried into v0.5. This is a tracking disposition, not completion or closure; existing owners, targets, and evidence requirements remain subject to #356 closeout. Before Definition of Ready approval, #387 must link this per-item disposition and ensure any incomplete ownership/target is resolved in #356.
