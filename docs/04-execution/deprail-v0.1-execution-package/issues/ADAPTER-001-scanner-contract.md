# ADAPTER-001 Define the ScannerAdapter Contract
...
Define scanner metadata, compatibility, plan, execute, parse, and normalize boundaries without leaking tool-specific types into the domain.
