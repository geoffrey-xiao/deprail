# DISC-001 Define Detector and ProjectGraph Contracts
...
Create domain-neutral detector interfaces and a stable ProjectGraph with diagnostics and completeness.
