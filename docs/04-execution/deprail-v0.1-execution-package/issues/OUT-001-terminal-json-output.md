# OUT-001 Implement Terminal and JSON Presenters with Safe File Output
...
Produce concise human output, schema-valid machine output, and atomic files with correct stream separation.
