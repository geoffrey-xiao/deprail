# PROC-001 Implement the Safe External Process Runner
...
Execute binaries without a shell using deadlines, cancellation, output caps, approved environment, and process-tree cleanup.
...
Review contract boundaries, failure completeness, security assumptions, cross-platform behavior, test assertions, and any golden-file change. Perform line-by-line review and an isolated manual failure test.
