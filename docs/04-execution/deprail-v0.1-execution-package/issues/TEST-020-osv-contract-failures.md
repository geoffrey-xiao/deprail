# TEST-020 Build the OSV Contract and Failure Matrix
...
Test compatible, incompatible, missing, timeout, cancellation, non-zero, oversized, malformed, partial, and valid scanner behavior.
