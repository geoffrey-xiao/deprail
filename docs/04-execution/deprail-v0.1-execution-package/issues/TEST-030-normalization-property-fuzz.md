# TEST-030 Build Normalization Property and Fuzz Tests
...
Prove order independence, idempotence, stable keys, safe parser behavior, and alias/evidence invariants.
