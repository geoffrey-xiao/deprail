...
These epics are local source contracts for the proposed GitHub parent issues. They remain subject to PR #312, owner/reviewer approval, and GitHub tracking reconciliation.

| Epic | GitHub issue | Outcome | Child issues |
|---|---|---|---|
| EPIC-001 | [#313](https://github.com/geoffrey-xiao/deprail/issues/313) | Isolated workspace and rollback | V04-001 / #302 |
| EPIC-002 | [#314](https://github.com/geoffrey-xiao/deprail/issues/314) | Approval and controlled mutation | V04-002 / #307; V04-003 / #308 |
