...
The supplemental context package is under review in PR #312. The existing v0.4 Definition of Ready and ADR-0002 records remain authoritative. These proposed contracts are not implementation-ready until the owner accepts this crosswalk and the GitHub hierarchy is reconciled.
...
| 3 | EPIC-003 verification/rescan | V04-004 | verification and finding-transition evidence |
