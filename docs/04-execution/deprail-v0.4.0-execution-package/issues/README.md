...
These issue contracts are local source contracts for the GitHub sub-issues. They remain subject to PR #312, owner/reviewer approval, and the crosswalk in [`CONTRACT-CROSSWALK.md`](CONTRACT-CROSSWALK.md).
...
The release parent is [#299](https://github.com/geoffrey-xiao/deprail/issues/299). The GitHub hierarchy is #299 → #313–#317 → #302, #307–#311. No issue authorizes caller-worktree mutation, publication, autonomous approval, or unsupported ecosystems.
