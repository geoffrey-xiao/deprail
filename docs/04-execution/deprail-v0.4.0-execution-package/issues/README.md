...
| V04-008 | [#332](https://github.com/geoffrey-xiao/deprail/issues/332) | [EPIC-006 / #332](https://github.com/geoffrey-xiao/deprail/issues/332) | V04-001 through V04-007 | Isolated fix apply orchestration for `v0.4.0-preview.2` |

The release parent is [#299](https://github.com/geoffrey-xiao/deprail/issues/299). The GitHub hierarchy is #299 → #313–#317 → #302, #307–#311, with V04-007 and V04-008 tracked as additive scope changes. V04-008 is backlog work for `v0.4.0-preview.2`; no issue authorizes caller-worktree mutation, publication, autonomous approval, or unsupported ecosystems.
