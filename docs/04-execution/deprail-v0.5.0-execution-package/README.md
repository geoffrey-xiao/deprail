...
| API/OpenAPI and local listener | [PR #404](https://github.com/geoffrey-xiao/deprail/pull/404) merged a candidate profile; [#396](https://github.com/geoffrey-xiao/deprail/issues/396) remains in Review. The owner-selected, separately versioned history-projection direction is recorded in [merged PR #411](https://github.com/geoffrey-xiao/deprail/pull/411). A concrete [OpenAPI 3.1 candidate](../../../schemas/openapi/v1/openapi.yaml), examples, error mappings, and proposed local security bounds now exist and passed offline schema/example/size checks; they are not accepted or runtime-tested. | Independently review the exact history-projection fields/diagnostics, API/security profile, cursors, errors/version policy, and bounds; owner acceptance of any material contract decision remains separately required before freezing #396. |
